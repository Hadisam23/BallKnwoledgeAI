...
import { CheckIcon, XMarkIcon, PauseIcon, PlayIcon, RetryIcon } from './icons';
...
const GamePlay: React.FC<GamePlayProps> = ({ topic, questions, onGameEnd }) => {
  ...
  return (
    <div className="flex flex-col h-full w-full">
      ...
      <div className="flex justify-center gap-4 mb-4">
        <button onClick={() => setIsPaused(p => !p)} disabled={isAnswered} className="gradient-button !text-sm !py-2 !px-4">
